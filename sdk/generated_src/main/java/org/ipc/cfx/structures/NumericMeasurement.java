 ...
 * original type: CFX.Structures.NumericMeasurement
 */
public class NumericMeasurement extends Measurement {

  private NumericValue measuredValue;
  ...
  public NumericMeasurement setMeasuredValue(NumericValue measuredValue) {
  ...
  public NumericValue getMeasuredValue() {
    return measuredValue;
  }
}
