...
public class SamplingInformation {
  ...
  public SamplingInformation setSamplingMethod(SamplingMethod samplingMethod) {
   ...
   */
  @JsonSetter("LotSize")
  public SamplingInformation setLotSize(Double lotSize) {
  ...
  public SamplingInformation setSampleSize(Double sampleSize) {
