...
public class ReflowReading {
   ...
   */
  @JsonSetter("SubZone")
  public ReflowReading setSubZone(ReflowSubZoneType subZone) {
  ...
  public ReflowReading setReadingType(ReflowReadingType readingType) {
  ...
  public ReflowReading setReadingValue(Double readingValue) {
