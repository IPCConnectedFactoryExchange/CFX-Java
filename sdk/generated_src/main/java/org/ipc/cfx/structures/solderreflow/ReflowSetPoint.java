...
public class ReflowSetPoint {
   ...
   */
  @JsonSetter("SubZone")
  public ReflowSetPoint setSubZone(ReflowSubZoneType subZone) {
  ...
  public ReflowSetPoint setSetpointType(ReflowSetpointType setpointType) {
   ...
   */
  @JsonSetter("Setpoint")
  public ReflowSetPoint setSetpoint(Double setpoint) {
