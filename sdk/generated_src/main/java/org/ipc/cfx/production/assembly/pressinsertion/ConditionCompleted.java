...
public class ConditionCompleted extends CFXMessage {
  ...
  public ConditionCompleted setTransactionID(UUID transactionID) {
  ...
  /**
   * 
   * @param resultOfCondition the value
   */
  @JsonSetter("ResultOfCondition")
  public ConditionCompleted setResultOfCondition(StatusResult resultOfCondition) {
