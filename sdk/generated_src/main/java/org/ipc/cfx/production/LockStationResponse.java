 ...
 * original type: CFX.Production.LockStationResponse
 */
public class LockStationResponse extends CFXMessage {
   ...
   */
  @JsonSetter("Result")
  public LockStationResponse setResult(RequestResult result) {
    this.result = result;
    return this;
  }
