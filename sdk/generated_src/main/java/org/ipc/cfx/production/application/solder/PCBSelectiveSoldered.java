...
public class PCBSelectiveSoldered extends CFXMessage {
  ...
  public PCBSelectiveSoldered setTransactionId(UUID transactionId) {
  ...
  public PCBSelectiveSoldered setHeaderData(SelectiveSolderData headerData) {
  ...
  public PCBSelectiveSoldered setSolderedPCBs(SelectiveSolderedPCB[] solderedPCBs) {
