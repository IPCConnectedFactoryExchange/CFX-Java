...
public class ActivateRecipeRequest extends CFXMessage {
  ...
  public ActivateRecipeRequest setRecipeName(String recipeName) {
   ...
   */
  @JsonSetter("Revision")
  public ActivateRecipeRequest setRevision(String revision) {
   ...
   */
  @JsonSetter("Lane")
  public ActivateRecipeRequest setLane(Integer lane) {
    this.lane = lane;
    return this;
  }
   ...
   */
  @JsonSetter("Stage")
  public ActivateRecipeRequest setStage(Stage stage) {
    this.stage = stage;
    return this;
  }
