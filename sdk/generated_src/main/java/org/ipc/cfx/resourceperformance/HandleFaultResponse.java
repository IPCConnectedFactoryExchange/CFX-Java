 ...
 * original type: CFX.ResourcePerformance.HandleFaultResponse
 */
public class HandleFaultResponse extends CFXMessage {
   ...
   */
  @JsonSetter("Result")
  public HandleFaultResponse setResult(RequestResult result) {
    this.result = result;
    return this;
  }
